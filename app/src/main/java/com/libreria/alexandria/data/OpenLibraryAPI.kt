...
// llamadas desde una co-rutina.

interface OpenLibraryAPI {
    // Usa la Search API para buscar libros por
    // título y devuelve una lista de LibroDto.
    @GET("search.json")
    ...
    // por género, y devuelve una lista de ObraDto.
    ...
    // Usa la Works API para obtener información
    // específica de un libro para la pantalla de
